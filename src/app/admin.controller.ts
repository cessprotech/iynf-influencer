...
export class AdminController {
  ...
  @Logger(AdminController.name) private logger = new LogService();
  ...
  async getAll(@Query() query) {
    ...
    otherQuery.influencerId = { ne: '' };

    return await this.adminService.getAll(otherQuery, paginateOptions);
  }
  ...
  getInfluencer(@Param('_id') id: string) {
    ...
    return this.adminService.getOne(id, populate);
  }
}
