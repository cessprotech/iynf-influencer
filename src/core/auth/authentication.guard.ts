...
import { IAM, PUBLIC_KEY } from './decorators';
...
export class AuthenticationGuard implements CanActivate {
  constructor(
    ...
    @Inject(APP_CONFIG.USER_SERVICE) 
  ...
  async canActivate(
    ...
    let influencer: Record<string, any> = {}

    if (iam) {
      influencer = await this.appService.getMe(response.data.influencerId);
    }
